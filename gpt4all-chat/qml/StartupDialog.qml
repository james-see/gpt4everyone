...
When a GPT4Everyone model responds to you and you have opted-in, your conversation will be sent to the GPT4Everyone
Open Source Datalake. Additionally, you can like/dislike its response. If you dislike a response, you
can suggest an alternative response. This data will be collected and aggregated in the GPT4Everyone Datalake.

NOTE: By turning on this feature, you will be sending your data to the GPT4Everyone Open Source Datalake.
...
to download and will be used by Nomic AI to improve future GPT4Everyone models. Nomic AI will retain all
attribution information attached to your data and you will be credited as a contributor to any GPT4Everyone
model release that uses your data!")
        ...
        GridLayout {
            ...
            Label {
                id: optInStatistics
                text: qsTr("Opt-in to anonymous usage analytics used to improve GPT4Everyone")
                Layout.row: 0
                Layout.column: 0
                color: theme.textColor
                font.pixelSize: theme.fontSizeLarge
            ...
            Label {
                id: optInNetwork
                text: qsTr("Opt-in to anonymous sharing of chats to the GPT4Everyone Datalake")
                Layout.row: 1
                Layout.column: 0
                color: theme.textColor
                font.pixelSize: theme.fontSizeLarge
            ...
            RowLayout {
                ...
                RadioButton {
                    ...
                    Accessible.role: Accessible.RadioButton
                    Accessible.name: qsTr("Opt-in for network")
                    Accessible.description: qsTr("Allow opt-in anonymous sharing of chats to the GPT4Everyone Datalake")
                ...
                RadioButton {
                    ...
                    Accessible.description: qsTr("Allow opt-out anonymous sharing of chats to the GPT4Everyone Datalake")
